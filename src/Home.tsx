...
const Home: React.FC = () => {
  ...
  <div className="absolute inset-0 bg-[url('https://images.unsplash.com/photo-1497366216548-37526070297c?auto=format&fit=crop&w=1950&q=80')] bg-cover bg-center"></div>
</div>
          ...
          <div className="mt-10 grid md:grid-cols-2 gap-12 items-center">
            <div className="space-y-8 slide-in">
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <Link
                  to="/contact"
                  className="bg-orange-500 hover:bg-orange-600 text-white px-8 py-4 rounded-full transition-all transform hover:scale-105 inline-flex items-center justify-center"
                >
                  <MessageSquare className="mr-2" size={20} />
                  Contact Us
                </Link>
                ...
                <Link
                  to="/about"
                  className="glass-card px-8 py-4 rounded-full hover:bg-white/20 transition-all transform hover:scale-105 text-center"
                >
                  Learn More
                </Link>
              </div>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              <div
                key={index}
                className="bg-white p-8 rounded-2xl shadow-lg hover:shadow-2xl transition-all feature-card"
              >
                <div className="bg-orange-50 w-20 h-20 rounded-2xl flex items-center justify-center mb-6">
                  {feature.icon}
                </div>
