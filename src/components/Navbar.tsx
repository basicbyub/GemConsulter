        ...
        <div className="container mx-auto px-4 py-4">
          <div className="flex justify-between items-center">
            <Link to="/" className="flex items-center">
              ...
              <div>
                <span className="text-xl sm:text-2xl font-bold text-orange-500">VendorPro</span>
                <span className={`text-xl sm:text-2xl font-bold ${isScrolled ? 'text-gray-900' : 'text-gray-800'}`}> Solutions</span>
              </div>
            </Link>
