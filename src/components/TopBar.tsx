...
const TopBar: React.FC = () => {
  ...
  <a href="mailto:solutionsvendorpro@gmail.com" className="flex items-center hover:text-orange-400 transition-colors group">
    <Mail size={16} className="mr-2 group-hover:animate-bounce" />
    solutionsvendorpro@gmail.com
  </a>
</div>

        <div className="flex items-center space-x-4">
          <a href="mailto:solutionsvendorpro@gmail.com" className="hover:text-orange-400 transition-colors transform hover:scale-110">
            <Mail size={18} />
          </a>
